(function (e, t, n) {
    function i(n) {
        if (!r[n]) {
            ...
            if (t.console && console.warn && !e.migrateMute) {
                console.warn("JQMIGRATE: " + n);
                if (e.migrateTrace && console.trace) {
                    console.trace()
                }
            }
        }
    ...
    function s(t, n, r, s) {
        ...
        e._definePropertyBroken = true;
        t[n] = r
    }

    var r = {};
    e.migrateWarnings = [];
    if (!e.migrateMute && t.console && console.log) {
    ...
    e.attr = function (t, r, s, a) {
        ...
        if (a) {
            ...
            if (t && !c.test(d) && (o ? r in o : e.isFunction(e.fn[r]))) {
                return e(t)[r](s)
            }
        }
        if (r === "type" && s !== n && l.test(t.nodeName) && t.parentNode) {
            i("Can't change the 'type' of an input or button in IE 6/7/8")
        }
        if (!e.attrHooks[f] && h.test(f)) {
            e.attrHooks[f] = {
                get: function (t, r) {
                    var i, s = e.prop(t, r);
                    return s === true || typeof s !== "boolean" && (i = t.getAttributeNode(r)) && i.nodeValue !== false ? r.toLowerCase() : n
                }, set: function (t, n, r) {
                    var i;
                    if (n === false) {
                        e.removeAttr(t, r)
            ...
            if (p.test(f)) {
                i("jQuery.fn.attr('" + f + "') may use property instead of attribute")
            }
        }
    ...
    e.attrHooks.value = {
        get: function (e, t) {
            ...
            if (n !== "input" && n !== "option") {
                i("jQuery.fn.attr('value', val) no longer sets properties")
            }
            e.value = t
        }
    };
    var d, v, m = e.fn.init, g = e.parseJSON, y = /^(?:[^<]*(<[\w\W]+>)[^>]*|#([\w\-]*))$/;
    e.fn.init = function (t, n, r) {
        var s;
        if (t && typeof t === "string" && !e.isPlainObject(n) && (s = y.exec(t)) && s[1]) {
            if (t.charAt(0) !== "<") {
            ...
            if (e.parseHTML) {
                return m.call(this, e.parseHTML(e.trim(t), n, true), n, r)
            }
        }
    ...
    e.sub = function () {
        ...
        e.extend(true, t, this);
        t.superclass = this;
        t.fn = t.prototype = this();
        t.fn.constructor = t;
        t.sub = this.sub;
        t.fn.init = function (i, s) {
            if (s && s instanceof e && !(s instanceof t)) {
                s = t(s)
            }
    ...
    var S = e.event.add, x = e.event.remove, T = e.event.trigger, N = e.fn.toggle, C = e.fn.live, k = e.fn.die,
        L = "ajaxStart|ajaxStop|ajaxSend|ajaxComplete|ajaxError|ajaxSuccess", A = new RegExp("\\b(?:" + L + ")\\b"),
        O = /(?:^|\s)hover(\.\S+|)\b/, M = function (t) {
            if (typeof t !== "string" || e.event.special.hover) {
                return t
            }
            if (O.test(t)) {
                i("'hover' pseudo-event is deprecated, use 'mouseenter mouseleave'")
            }
    ...
    e.event.add = function (e, t, n, r, s) {
        if (e !== document && A.test(t)) {
            i("AJAX events should be attached to document: " + t)
        }
    ...
    e.fn.toggle = function (t, n) {
        ...
        var r = arguments, s = t.guid || e.guid++, o = 0, u = function (n) {
            ...
            n.preventDefault();
            return r[i].apply(this, arguments) || false
        };
        u.guid = s;
        while (o < r.length) {
            r[o++].guid = s
